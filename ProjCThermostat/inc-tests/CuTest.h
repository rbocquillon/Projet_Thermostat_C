...
#define CuAssertCharEquals(tc,ex,ac)           CuAssertCharEquals_LineMsg((tc),__FILE__,__LINE__,NULL,(ex),(ac))
#define CuAssertCharEquals_Msg(tc,ms,ex,ac)    CuAssertCharEquals_LineMsg((tc),__FILE__,__LINE__,(ms),(ex),(ac))
